...
if test "haystack_hotspots -h" ; then
	...
	curl -fL http://alternate.meme-suite.org/meme-software/4.12.0/meme_4.12.0.tar.gz \
		-o $HOME/haystack_bio/binaries/meme_4.11.2.tar.gz  \
	tar -xzf $HOME/haystack_bio/binaries/meme_4.11.2.tar.gz -C $HOME/haystack_bio/binaries
	rm -f $HOME//haystack_bio/binaries/meme_4.11.2.tar.gz

	cd $HOME/haystack_bio/binaries/meme_4.11.2
