...
Step 3: Run the pipeline inside the data directory
	 ...
	 haystack_pipeline samples_names.txt  hg19 --output_directory $HOME/HAYSTACK_OUTPUT_H3K27Aac --blacklist hg19
...
**Sub-command run by _haystack_pipeline_**: 	
       ...
       haystack_hotspots samples_names.txt  hg19 --output_directory $HOME/HAYSTACK_OUTPUT_H3K27Aac --blacklist hg19
...
the BAM files listed in it the current folder, you can use the following command
