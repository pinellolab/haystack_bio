...
#include "meme.h"
// these were both 100,000 but I change them to 100,003 to make them prime
// as prime numbers provide better resistance to hash collisions
#define MOTIF_HASH_SIZE 100003
