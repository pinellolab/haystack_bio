 ...
 **************************************************************************/
void output_secondary_motif(FILE *xml_output, SECONDARY_MOTIF_T *smotif, int n_secondary_motifs,
    LINKLST_T *rmotifs, int margin, int bin, char *tab, int indent, char **buffer, int *buffer_len);
