...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="top">
    ...
    <div class="pad1">
      <div class="prog_logo big">
        <img src="{$site_url}/doc/images/dreme_icon.png" alt="DREME Logo"/>
        <h1>DREME</h1>
  ...
  <xsl:template name="motifs">
    ...
    <div class="box">
      <xsl:choose>
        <xsl:when test="count(/dreme/motifs/motif) = 0">
          <p><b>No motifs were discovered!</b></p>
        </xsl:when>
        <xsl:otherwise>
          <p> 
          ...
          <table id="dreme_motifs" class="dreme_motifs">
            ...
            <tr class="motif_head">
              <td>&nbsp;</td>
              <th>Motif <div class="help" onclick="help(this,'pop_motifs_name')"></div></th>
              <th>Logo <div class="help" onclick="help(this,'pop_motifs_logo')"></div></th>
              <th>RC Logo <div class="help" onclick="help(this,'pop_motifs_rc_logo')"></div></th>
              <th>E-value <div class="help" onclick="help(this,'pop_motifs_evalue')"></div></th>
              <th>Unerased E-value <div class="help" onclick="help(this,'pop_motifs_uevalue')"></div></th>
              <th>More <div class="help" onclick="help(this,'pop_more')"></div></th>
              <th>Submit <div class="help" onclick="help(this,'pop_submit')"></div></th>
              <th>Download <div class="help" onclick="help(this,'pop_download')"></div></th>
            </tr>
            </thead>
            <tbody>
            <xsl:for-each select="/dreme/motifs/motif">
    ...
    <div id="expanded_motif" style="display:none">
      <div class="box expanded_motif" style="margin-bottom:5px;">
        ...
        <table class="details">
          <thead>
            <tr>
              <th>Positives <div class="help" onclick="help(this,'pop_motif_positives')"></div></th>
              <th>Negatives <div class="help" onclick="help(this,'pop_motif_negatives')"></div></th>
              <th>P-value <div class="help" onclick="help(this,'pop_motif_pvalue')"></div></th>
              <th>E-value <div class="help" onclick="help(this,'pop_motif_evalue')"></div></th>
              <th>Unerased E-value <div class="help" onclick="help(this,'pop_motif_uevalue')"></div></th>
            </tr>
          </thead>
          <tbody>
            <tr>
