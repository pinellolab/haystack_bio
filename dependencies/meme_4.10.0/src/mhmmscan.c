...
void init_mhmmscan_options(MHMMSCAN_OPTIONS_T *options) {
  ...
  options->BED_FILENAME = "mhmmscan.bed";
  ...
  options->bed_stylesheet_path = NULL;
  options->bed_stylesheet_local_path = NULL;
...
void cleanup_mhmmscan_options(MHMMSCAN_OPTIONS_T *options) {
  ...
  myfree(options->bed_path);
  myfree(options->bed_stylesheet_path);
  myfree(options->bed_stylesheet_local_path);
