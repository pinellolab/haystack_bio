...
typedef struct mhmmscan_options {
  ...
  char *constants_stylesheet_path; // Path to master copy of constants style sheet for CisML
  char *constants_stylesheet_local_path; // Path to working copy of constants style sheet for CisML
  ...
  char *bed_stylesheet_path; // Path to master copy of BED stylesheet for CisML
  char *bed_stylesheet_local_path; // Path to working copy of BEDsheet for CisML
  ...
  char *bed_path; // Path to MHMMSCAN BED output file
  ...
  const char* BED_FILENAME;     // Name of GFF output file.
